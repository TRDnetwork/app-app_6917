...
function App() {
  ...
  return (
    <div className="min-h-screen bg-bg text-text font-sans leading-relaxed">
      {/* a11y fix: Skip link for keyboard navigation */}
      <a href="#main-content" className="sr-only focus:not-sr-only fixed top-4 left-4 bg-accent text-white px-4 py-2 rounded-lg z-50 transition-all duration-200" aria-label="Skip to main content">
        Skip to Content
      </a>

      <header className="fixed top-0 left-0 right-0 z-50 bg-surface/80 backdrop-blur-md border-b border-[#e6e4e0]" role="banner">
      ...
      <main id="main-content">
        <section
          ...
          aria-label="Hero section featuring Jane Doe, Full-Stack Developer & Designer"
        >
            ...
            {isSubmitted ? (
              ...
              >
                ...
                <button
                  ...
                  className="w-full bg-accent text-white py-4 rounded-lg font-semibold text-lg hover:bg-[#ff8c42] transition-all duration-300 shadow-lg hover:shadow-accent/25 transform hover:translate-y-[-4px]"
